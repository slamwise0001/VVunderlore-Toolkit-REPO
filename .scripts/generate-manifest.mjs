...
function walk(dir, relative = '') {
	...
	for (const entry of entries) {
	  ...
	  // build a kebab-cased key from the relativePath:
	  const defaultKey = relativePath
		.replace(/[/\\]/g, '-')      // slash → dash
		.replace(/\.[^.]+$/, '')     // drop file extension
		.toLowerCase();
  
	  // build a human-friendly name from the folder/file name:
	  const defaultDisplayName = entry.name
