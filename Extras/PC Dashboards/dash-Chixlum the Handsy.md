## Chixlum the Handsy
```dataviewjs
const character = dv.page("People/Player Characters/Active/Chixlum the Handsy");
...
if (character) {
    ...
    const infoTableData = {
        ...
        stproficiencies: stProfs.join(", ") || "None"
    };
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid #ccc; padding: 5px;">Saving Throws</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td style="border: 1px solid #ccc; padding: 5px;">${infoTableData.stproficiencies}</td>
                </tr>
            </tbody>
        </table>
    `;
